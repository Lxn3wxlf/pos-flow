...
export const buildCustomerReceipt = (order: OrderData): any[] => {
  ...
  return [
    ...
    { type: 'raw', format: 'plain', data: 'CASBAH\n' },
    { type: 'raw', format: 'plain', data: ESCPOS.NORMAL },
    { type: 'raw', format: 'plain', data: 'GRILL & COFFEE\n' },
    { type: 'raw', format: 'plain', data: '194 Marine Drive\n' },
    { type: 'raw', format: 'plain', data: 'Tel: 065 683 5702\n' },
    ...
    { type: 'raw', format: 'plain', data: ESCPOS.FEED(1) },
    { type: 'raw', format: 'plain', data: ESCPOS.CENTER },
    { type: 'raw', format: 'plain', data: 'Thank you for visiting CASBAH!\n' },
